...
const Root = component(() => {
  ...
  // Provided and waiting. Nothing in this starter fetches anything, but the
  // cache is where data belongs the moment something does:
  //
  //   const entry = useQuery({ tags: [tag('note', { id })], fetch: () => … });
